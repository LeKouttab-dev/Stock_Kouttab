...
export const fr = {
  ...
  calendrier: {
    titre: 'Calendrier',
    sousTitre: "Les agendas Google de l'association, en lecture seule.",
    mesAgendas: 'Agendas',
    chercherAgenda: 'Filtrer les agendas…',
    toutAfficher: 'Tout afficher',
    toutMasquer: 'Tout masquer',
  ...
  tickets: {
    ...
    clore: 'Pièce reçue — retirer la demande',
    cloture: 'Demande retirée de la liste.',
    annuler: 'Annuler la demande',
    confirmAnnulation: 'Annuler cette demande de justificatif ? Elle sera retirée de la liste.',
