...
def barcode_scanner_component():
    """Composant de scanner de codes barres professionnel avec retour direct"""
    
    # Créer un composant Streamlit qui peut retourner des valeurs
    scanner_html = """
    <!DOCTYPE html>
    <html lang="fr">
    <head>
    ...
    <body>
        ...
        <script>
            ...
            function sendToStreamlit(key, value) {
                ...
                try {
                    // Méthode 1: postMessage direct au parent
                    ...
                    // Méthode 2: Créer un input dans le document parent
                    setTimeout(() => {
                        try {
                            ...
                            input.name = key;
                            input.value = value;
                            input.id = 'streamlit_' + key + '_' + Date.now();
                            
                            // Ajouter au document parent
                            if (window.parent.document) {
                                const form = window.parent.document.querySelector('form') || window.parent.document.body;
                                ...
                                console.log('✅ Input créé dans le parent:', input);
                            }
                        } catch (error) {
                    ...
                    setTimeout(() => {
                        try {
                            ...
                            console.log('✅ CustomEvent dispatché');
                        } catch (error) {
                            console.error('❌ Erreur CustomEvent:', error);
                        }
                    }, 200);
            ...
            function handleScanSuccess(barcode) {
                ...
                console.log('Envoi automatique du barcode à Streamlit...');
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (testBtn) {
                    testBtn.addEventListener('click', () => {
                        updateDebugInfo('Test communication - envoi barcode test...');
